...
public class income extends Transaction {
    ...
    // Menginisialisasi objek income dengan mewarisi atribut dan metode dari kelas Transaction.
    public income(Date TimeStamp, String Category, Double Total, String Notes) {
         super(TimeStamp, Category, Total, Notes);
    }
    
    //mengimplementasikan bagaimana method getdata() di parent class bekerja 

    // method ini berfungsi untuk menghubungkan program ke mysql sehingga data dari mysql tersebut bisa dibuat menjadi
    // sebuah objek income 
